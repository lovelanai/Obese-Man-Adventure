...
downsound.src = "./assets/music/blur.mp3";
...
var outside = new Audio();
outside.src = "./assets/music/outside.mp3";

var clicksound = new Audio();
clicksound.src = "./assets/music/clicksound.mp3";

var opendoor = new Audio();
opendoor.src = "./assets/music/opendoor.mp3";

var bowser = new Audio();
bowser.src = "./assets/music/bowser.mp3";

var inventory = new Audio();
inventory.src = "./assets/music/inventory.mp3";

var what = new Audio();
what.src = "./assets/music/what.mp3";

var kick = new Audio();
kick.src = "./assets/music/kick.mp3";

var error = new Audio();
error.src = "./assets/music/error.mp3";
...
var final = new Audio();
final.src = "./assets/music/finalscene.mp3";

var kitchen = new Audio();
kitchen.src = "./assets/music/kitchen.mp3";

var fredrik = new Audio();
fredrik.src = "./assets/music/fredrik.mp3";

var omg = new Audio();
omg.src = "./assets/music/omg.mp3";